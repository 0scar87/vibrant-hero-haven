  ...
  return (
    <div className="usage-card w-full max-w-3xl mx-auto mt-16 animate-fade-in-delay-2 opacity-0">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-white text-sm font-medium">Your Weekly Usage</span>
      </div>
      ...
      <div className="flex justify-between text-xs">
        <span className="text-white/70">{minutesUsed} minutes used</span>
        <span className="text-white/70">{minutesRemaining} minutes remaining</span>
      </div>
      ...
      <div className="flex items-center gap-2 mt-3">
        ...
        <span className="text-white/60 text-xs">Resets in {resetsInDays} days</span>
      </div>
    </div>
  );
}
